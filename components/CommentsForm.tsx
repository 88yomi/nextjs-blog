...
import { CommentsFormProps } from '../interfaces'
...
const CommentsForm: NextPage<CommentsFormProps> = ({ slug }) => {
  ...
  const handleCommentSubmission: React.MouseEventHandler<HTMLButtonElement> = () => {
    setError(false)
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          <input type="checkbox" ref={storeDataEl} id='storeData' name="storeData" defaultChecked={true} />
          <label htmlFor="storeData" className='ml-2 text-gray-500 cursor-pointer'> Save my email and name for the next time I comment</label>
        </div>
      </div>
